//! Read a litter box detail payload with the async reqwest transport.
//!
//! Run with:
//! `cargo run -p petkit-client --example reqwest_async_litter_detail --no-default-features --features async,reqwest-async`
//!
//! Shared env vars:
...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    let response: LitterDeviceDetailResponse = litter.device_detail().await?;
