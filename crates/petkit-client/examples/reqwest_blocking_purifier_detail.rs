//! Read a purifier detail payload with the blocking reqwest transport.
//!
//! Run with:
//! `cargo run -p petkit-client --example reqwest_blocking_purifier_detail --no-default-features --features blocking,reqwest-blocking`
//!
//! Shared env vars:
