//! Read a purifier detail payload with the async reqwest transport.
//!
//! Run with:
//! `cargo run -p petkit-client --example reqwest_async_purifier_detail --no-default-features --features async,reqwest-async`
//!
//! Shared env vars:
...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    let response: PurifierDeviceDetailResponse = purifier.device_detail().await?;
